...
sio::client *g_pSocketIOClient;
namespace sio
{
    client::client():
        m_impl(new client_impl())
    {
        g_pSocketIOClient = this;
    }
    ...
    void client::set_connectstatuechanged_listener(con_listener const& l)
    {
        m_impl->set_connectstatuechanged_listener(l);
    }
    ...
    int client::getConectedState()
    {
        return m_impl->m_con_state;
    }
